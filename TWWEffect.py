...
class TWWTech:
    ...
    def __init__(self,name,stat_effects,other_effects,stat_effects_units,other_effects_units):
        self.name = name
        self.stat_effects = stat_effects
        self.other_effects = other_effects
        self.stat_effects_units = stat_effects_units
        self.other_effects_units = other_effects_units
    
    def __str__(self):
        return f"TWWTech: {self.name}"
    ...
    def __call__(self,unit,remove=False):
        ...
        for (stat, val, how), units in zip(self.stat_effects,self.stat_effects_units):
